<link href="file:///C|/ColdFusion9/wwwroot/stylesheets/bootstrap.css" rel="stylesheet" type="text/css" />
<cfoutput>
<!--- heading of the page --->
<h2>#title#</h2>
...
<div class="span7">
    ...
    #submitTag(value="Save as Draft",name="draft",class="btn")# &nbsp; #submitTag(value="Save & Publish",name="publish",class="btn btn-primary")# <br />
