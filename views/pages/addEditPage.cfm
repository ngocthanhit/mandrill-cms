...
Created by: #linkto(text=createdBy.uname,controller="users",action="profile",key=createdBy.userid)# on #DateFormat(Newpages.createdAt,"dd/mm/yyyy")# <br />
<cfif IsDefined("updatedBy") >
Last updated by: #linkto(text=updatedBy.uname,controller="users",action="profile",key=updatedBy.userid)# on #DateFormat(Newpages.updatedat,"dd/mm/yyyy")#<br />
</cfif>
